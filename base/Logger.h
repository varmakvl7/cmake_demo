...
#define AIPException_LOG_ERROR(file,line) A_LOG_SEV(boost::log::trivial::severity_level::error) << file << ":" << line << ":"
#define AIPException_LOG_FATAL(file,line) A_LOG_SEV(boost::log::trivial::severity_level::fatal) << file << ":" << line << ":"
